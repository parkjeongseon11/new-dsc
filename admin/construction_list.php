		...
		<article>
				...
				<table>
					...
					?>
						<tr>
							...
							<td onclick="location.href='<?php echo G5_URL."/admin/construction_view.php?id=".$list[$i]['id']."&page=".$page; ?>'"><?php echo $list[$i]['etc']; ?></td>
							...
							<td><a href="<?php echo G5_URL."/admin/construction_write.php?id=".$list[$i]['id']."&page=".$page; ?>" class="btn01 btn" style="padding:5px 10px;">수정</a> <a href="<?php echo G5_URL."/admin/construction_delete.php?id=".$list[$i]['id']."&page=".$page; ?>" class="btn01 btn" style="padding:5px 10px;">삭제</a></td>
						</tr>
					<?php
						}
						if(count($list)==0){
					?>
						<tr>
							<td colspan="5" class="text-center" style="padding:50px 0;">등록된 동영상정보가 없습니다.</td>
						</tr>
					<?php
						}
					?>
			...
			<div class="num_list01">
				...
				<?php for($i=$start_page;$i<=$end_page;$i++){ ?>
					<li class="<?php echo $page==$i?"active":""; ?>"><a href="<?php echo G5_URL."/admin/construction_list.php?page=".$i; ?>"><?php echo $i; ?></a></li>
				<?php } ?>
