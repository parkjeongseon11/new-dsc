				...
				<div class="adm-table02">
					<table>
						...
						<tr>
							...
							<td>
								<select name="status" id="status" class="adm-input01 grid_100" required>
									...
									<option value="3" <?php echo isset($write['status'])&&$write['status']=="3"?"selected":""; ?>>배송대기</option>	
									<option value="4" <?php echo isset($write['status'])&&$write['status']=="4"?"selected":""; ?>>배송중</option>	
									<option value="5" <?php echo isset($write['status'])&&$write['status']=="5"?"selected":""; ?>>배송완료</option>	
								</select>
							</td>
						</tr>
						...
						<tr>
							<th>제품명</th>
							<td>
								<select name="model" id="model" class="adm-input01 grid_100" required multiple style="height:auto">
									<!-- <option value="<?php echo $write['model']?>"><?php echo $write['model']?></option> -->
									<?php
										for($i=0;$i<count($model_list);$i++){
											for($j=0;$j<count($name);$j++){
									?>
										<option value="<?php echo $model_list[$i]['id']; ?>" <?php echo $name[$j]==$model_list[$i]['name']?"selected":""; ?>><?php echo $model_list[$i]['name']; ?></option>
									<?php }
										}
									?>
								</select>
